...
function SideBar({result}) {
  ...
  return (
     <div className='bg-white rounded-2xl border-gray-200 shadow-sm
     p-5 space-y-6 '>
...
<span className="text-yellow-700 font-bold text-sm">
  {result.impotance}
         ...
         ❓ Important Questions
          ...
          bg-indigo-50 border border-indigo-200 p-3'>
...
<li key={i}>{t}</li>
           ...
           <div className='mb-4 rounded-lg
          bg-purple-50 border border-purple-200 p-3'>
...
<li key={i}>{t}</li>
           ...
           <div className='mb-4 rounded-lg
          bg-blue-50 border border-blue-200 p-3'>
