...
function Notes() {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-gray-100
    ...
    >
      ...
      items-start flex md:items-center justify-between gap-4 flex-col
      md:flex-row"
      >
  ...
  text-white text-sm"
      ...
      <motion.div
        ...
        className="mb-12"
      >
        <TopicForm loading={loading} setResult={setResult}
      ...
      {loading && (
        ...
        >Generating exam-notes</motion.div>
      )}
      {error && (
