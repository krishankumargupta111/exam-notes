     ...
     lg:grid-cols-2 gap-20 items-center"
      >
        <div>
          ...
          leading-tigth bg-gradient-to-br from-black/90 via-black/60
          to-black/90 bg-clip-text text-transparent"
              whileHover={{ y: -4 }}
              style={{
          ...
          bg-clip-text text-transparent"
            ...
            >
              ...
              and revisions-ready content using AI-faster,cleaner and smarter.
            </motion.p>
      ...
      md:grid-cols-4 gap-10">
        <Feature icon="📚" title="Exam Notes" des="High-yield exam-oriented 
notes with revision points."/>
        <Feature icons="📁" title="Project Notes" des="well-structured documentation for assignments
   & projects"/>
        <Feature icons="📊" title="Diagrams" des="auto generated 
  "/>
